...
export const TOWERS = {
  archer: {
    ...
    levels: [
      { dmg: 17, rate: 750, range: 130 },
      { dmg: 30, rate: 700, range: 140, cost: 80, label: "Twin Archers" },
      { dmg: 46, rate: 650, range: 150, cost: 120, label: "Archer Trio" },
    ],
    branches: {
      a: {
  ...
  knight: {
    ...
    branches: {
      a: {
        name: "Paladin Order", cost: 320, stats: { dmg: 36, rate: 800, range: 80, hp: 280, count: 3, magic: true, stun: 0.25, stunDur: 900, heal: 7 }, desc: "Three radiant paladins: MAGIC blows that ignore armor, chance to stun, and they mend their own wounds.",
        rank4: {
          a: { name: "Grand Champion", cost: 680, stats: { dmg: 110, rate: 900, range: 85, hp: 950, count: 1, magic: true, stun: 0.35, stunDur: 1100, heal: 18, giant: true }, desc: "The three paladins kneel — and ONE colossal champion rises: a living fortress whose hammer falls like a star." },
          b: { name: "Radiant Basilica", cost: 680, stats: { dmg: 44, rate: 780, range: 85, hp: 340, count: 3, magic: true, stun: 0.25, stunDur: 900, heal: 10, sear: 14 }, desc: "Holy ground follows the paladins' boots — enemies near them smolder in sacred light." },
        },
      },
      b: {
        name: "Berserker Hall", cost: 320, stats: { dmg: 20, rate: 320, range: 80, hp: 150, count: 4 }, desc: "FOUR berserkers with whirling axes. Frailer than knights, but a storm of steel.",
        rank4: {
          a: { name: "Wolf Lodge", cost: 680, stats: { dmg: 24, rate: 300, range: 130, hp: 175, count: 4, unitSpeed: 150, respawnMs: 4000, rider: true }, desc: "Berserkers astride great wolves: faster than anything on the road, and back from the dead in a heartbeat." },
          b: { name: "Blood Frenzy", cost: 680, stats: { dmg: 22, rate: 300, range: 80, hp: 160, count: 4, frenzy: true, lifesteal: 0.6 }, desc: "Every wound they deal feeds them — and the longer they fight, the faster the axes swing." },
        },
      },
    },
  },
  ...
  catapult: {
    ...
    branches: {
      ...
      b: {
        name: "The Log Roller", cost: 340, stats: { logDmg: 110, rate: 5200, range: 999, minRange: 0, logSpeed: 118, logWidth: 22, splash: 0, roller: true }, desc: "Stops throwing and starts ROLLING. A great trimmed log is released down a bearing YOU choose, crushing everything it touches and grinding on until it leaves the board — each foe it rolls over slows it a little, so the first of a column take the worst of it. Point it along the road and it eats the road, all three lanes.",
        rank4: {
          a: { name: "The Iron Drum", cost: 680, stats: { logDmg: 190, rate: 5000, range: 999, minRange: 0, logSpeed: 126, logWidth: 28, splash: 0, roller: true, logStun: 900, logSlow: 0.4, logSlowDur: 2000 }, desc: "An iron-banded drum twice the weight: heavier, wider, and what it fails to kill it leaves stunned and staggering in the ruts." },
          b: { name: "The Powder Keg Run", cost: 680, stats: { logDmg: 135, rate: 4800, range: 999, minRange: 0, logSpeed: 132, logWidth: 24, splash: 0, roller: true, logBurn: 26, logBurnDur: 3000, logBlast: 96, logBlastDmg: 220 }, desc: "The log is packed with powder and lit at the release: it burns everything it grinds past, and when it finally leaves the field it goes up." },
        },
      },
    },
  },
  ...
  goldworks: {
    ...
    branches: {
      a: {
        name: "Royal Mint", cost: 320, stats: { income: 40, compound: 2, range: 0, rate: 0 }, desc: "Pure compounding wealth: every wave it survives, its payout grows by 2. Plant it early and let time do the arithmetic.",
        rank4: {
          ...
          b: { name: "Philosopher's Stone", cost: 650, stats: { income: 55, compound: 3, range: 0, rate: 0 }, desc: "Lead into gold and gold into more gold: the richest single wage on the board, compounding every wave it holds." },
        },
      },
      b: {
        name: "Transmuter", cost: 320, stats: { dmg: 34, rate: 1300, range: 130, magic: true, bountyAura: 0.25, auraRange: 120 }, desc: "The alchemist takes the field: acid vials that melt armor's owners, and an aura where every kill pays a quarter more.",
        rank4: {
          a: { name: "Midas Cannon", cost: 680, stats: { dmg: 40, rate: 1250, range: 135, magic: true, midas: 12, bountyAura: 0.25, auraRange: 120 }, desc: "Every 12th shot turns a lesser foe to solid gold — killed outright, and worth triple." },
          b: { name: "Lead to Gold", cost: 680, stats: { dmg: 36, rate: 1300, range: 130, magic: true, bountyAura: 0.3, auraRange: 130, shredAura: 0.25 }, desc: "The aura transmutes armor itself: everything inside it wears a quarter less plate." },
        },
      },
    },
  },
  trapsmith: {
    ...
    branches: {
      a: {
        name: "Springworks", cost: 320, stats: { trapDmg: 120, splash: 34, maxCharges: 8, chargeEvery: 1900, range: 195, root: 2200, rate: 0, trapKind: "jaws" }, desc: "Bear-iron jaws instead of spikes: whatever steps in is HELD FAST — a block with no knight in it.",
        rank4: {
          a: { name: "Guillotine Gate", cost: 650, stats: { trapDmg: 150, splash: 36, maxCharges: 9, chargeEvery: 1700, range: 200, root: 2400, execute: 0.22, rate: 0, trapKind: "jaws" }, desc: "Anything under a fifth of its health that touches the iron is simply finished." },
          b: { name: "Caltrop Field", cost: 650, stats: { trapDmg: 124, splash: 38, maxCharges: 11, chargeEvery: 1500, range: 200, root: 2000, caltrops: 6000, caltropSlow: 0.35, rate: 0, trapKind: "caltrop" }, desc: "Beds of caltrops laid thick — every one that springs leaves ground that keeps slowing the column long after the snap." },
        },
      },
      b: {
  ...
  gunpowder: {
    ...
    branches: {
      a: {
        name: "The Bombard Yard", cost: 350, stats: { dmg: 150, rate: 2100, range: 122, splash: 78, burn: 16, burnDur: 2600, mDmg: 150, mRate: 2700, mRange: 196, count: 2 }, desc: "The bombardier gets the budget: fat powder charges with a wide, burning blast. The musket keeps its post beside him regardless.",
        rank4: {
          a: { name: "The Grand Battery", cost: 680, stats: { dmg: 200, rate: 2000, range: 132, splash: 96, burn: 20, burnDur: 3000, shells: 2, mDmg: 170, mRate: 2600, mRange: 200, count: 2 }, desc: "TWO charges to a throw, falling wide apart — the bombardier stops aiming at foes and starts aiming at stretches of road." },
          b: { name: "Dragon's Breath", cost: 680, stats: { dmg: 165, rate: 2050, range: 128, splash: 86, burn: 34, burnDur: 3600, burnSpread: true, mDmg: 165, mRate: 2650, mRange: 198, count: 2 }, desc: "Powder cut with pitch and something worse: the fire it leaves leaps from body to body down the column." },
        },
      },
      b: {
        name: "The Long Muskets", cost: 350, stats: { dmg: 92, rate: 2200, range: 112, splash: 58, mDmg: 300, mRate: 2600, mRange: 250, mPierce: true, count: 2 }, desc: "The musketeer gets the budget: a long barrel that reaches most of the field and punches clean through any armor. The bombardier keeps lobbing regardless.",
        rank4: {
          ...
          b: { name: "The Grapeshot Crew", cost: 680, stats: { dmg: 100, rate: 2150, range: 116, splash: 58, mDmg: 190, mRate: 2400, mRange: 240, mPierce: true, mShots: 4, mSpread: 0.26, count: 2 }, desc: "The musket is bored out into a scattergun: FOUR balls in a spreading fan, every one of them still punching armor." },
        },
      },
    },
  },
  ...
  assassin: {
    ...
    branches: {
      a: {
        name: "The Silent Court", cost: 360, stats: { dmg: 120, rate: 1850, range: 118, hp: 150, count: 2, unitSpeed: 128, preyMult: 2, pierce: true, cull: 0.18 }, desc: "Two blades of the Court afield: they pierce any armor, strike support foes TWICE as hard, and finish the nearly-dead outright.",
        rank4: {
          a: { name: "Kingslayer", cost: 700, stats: { dmg: 150, rate: 1850, range: 122, hp: 175, count: 2, unitSpeed: 132, preyMult: 2.2, pierce: true, cull: 0.22, preyAnywhere: true }, desc: "No healer, herald or bell-ringer is safe ANYWHERE on the field — the Court's knives cross the map for them." },
          b: { name: "The Open Contract", cost: 700, stats: { dmg: 104, rate: 1750, range: 122, hp: 175, count: 3, unitSpeed: 132, preyMult: 1.4, pierce: true, cull: 0.2, silence: 3000, openContract: true }, desc: "The guild tears up its charter and takes ANY name offered. Three blades, ordinary standing orders — first, last, strongest, weakest — and they still hold no ground and block nothing. The cut still steals the voice." },
        },
      },
      b: {
  ...
  sunforge: {
    ...
    branches: {
      a: {
        name: "Solar Lance", cost: 350, stats: { dps: 85, range: 124, rampMax: 4, rampTime: 2800, igniteBurn: 18, igniteDur: 2000, rate: 0 }, desc: "Hotter, faster, crueler — and at full focus the beam sets its victim alight.",
        rank4: {
          a: { name: "Noon Eternal", cost: 680, stats: { dps: 92, range: 132, rampMax: 4, rampTime: 2600, igniteBurn: 20, igniteDur: 2200, beamSplash: 42, rate: 0 }, desc: "At full focus the light overflows — everything near the victim burns in the spill." },
          b: { name: "Sun Spear", cost: 680, stats: { dps: 85, range: 130, rampMax: 6, rampTime: 3000, igniteBurn: 20, igniteDur: 2200, rate: 0 }, desc: "No ceiling worth the name: the ramp climbs to SIX times, if you have the patience to hold it." },
        },
      },
      b: {
        name: "Moon Prism", cost: 350, stats: { dps: 70, range: 124, rampMax: 3.5, rampTime: 2800, beamSlow: 0.3, rate: 0 }, desc: "Cold light: the held foe wades against it, slowed the whole while.",
        rank4: {
          a: { name: "Gravity Well", cost: 680, stats: { dps: 74, range: 132, rampMax: 3.5, rampTime: 2600, beamSlow: 0.35, wellRoot: true, rate: 0 }, desc: "At full focus the beam becomes a fist: the victim STOPS, pinned in the light. Yes — even him." },
          b: { name: "Eclipse", cost: 680, stats: { dps: 66, range: 130, rampMax: 3.5, rampTime: 2800, beamSlow: 0.3, beams: 2, rate: 0 }, desc: "Two beams, sun and shadow — a second foe held at half focus." },
        },
      },
    },
  },
  support: {
    ...
    branches: {
      a: {
        name: "Rimecaller", cost: 310, stats: { slow: 0.4, range: 135, nova: 10, novaFreeze: 900, novaEvery: 7000 }, desc: "Deep cold thickens the air — and every few heartbeats a frost nova flash-freezes the whole aura.",
        rank4: {
          a: { name: "Absolute Zero", cost: 610, stats: { slow: 0.5, range: 145, colddps: 11, nova: 16, novaFreeze: 1100, novaEvery: 6000 }, desc: "The air itself turns lethal: everything in the aura slows to a crawl and freezes by inches." },
          b: { name: "Permafrost Heart", cost: 610, stats: { slow: 0.38, range: 145, nova: 10, novaFreeze: 900, novaEvery: 6000, brittle: 0.35, brittleDur: 4000 }, desc: "Novas leave foes BRITTLE — frozen flesh takes a third more from every arrow, blade, and stone." },
        },
      },
      b: {
        name: "Lifebinder", cost: 310, stats: { slow: 0.12, heal: 24, range: 135 }, desc: "Warm light within the cold: wounded knights standing in the aura are mended swiftly.",
        rank4: {
          a: { name: "Guardian's Grace", cost: 610, stats: { slow: 0.12, heal: 26, range: 145, shield: true }, desc: "Knights in the light carry a shimmering ward that swallows one blow whole, then slowly reforms." },
          b: { name: "High Cathedral", cost: 610, stats: { slow: 0.12, heal: 30, range: 150, mend: 1 }, desc: "A wave survived is a wall reborn: each cleared wave, the cathedral restores 1 castle HP." },
        },
      },
    },
  },
