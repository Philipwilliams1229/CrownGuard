...
export const RIGS = {
  ...
  // ...and the four finals: the Kingslayer (gilded mask, long estoc, black and gold), the Open Contract (a sellsword's hat, pauldron, purse and contract),
  // the Widow's Kiss (black lace veil and mourning cloak, a needle with a bead of venom), the Plague Bearer (beak mask, spore censer)
  assassinUnitAA: { kind: "assassin", box: { hw: 24, up: 30, down: 4 }, p: { h: 22, skin: "#d8b08c", cloth: "#221a2e", cloth2: "#383244", hair: "#3e2e5a", cape: "#a82838", wcol: "#eef0f6", trim: "#e0b84a", eyes: "#fff0b0", mask: "#e8c14a", face: "gild", brim: "#d8b34a", hem: "#d8b34a", offhand: true, blade: "long" } },
  assassinUnitAB: { kind: "assassin", box: { hw: 22, up: 32, down: 4 }, p: { h: 22, skin: "#d8b08c", cloth: "#4a3e58", cloth2: "#7a5a3a", hair: "#46385e", cape: "#7a5aa8", wcol: "#d8dce4", trim: "#c8a050", eyes: "#f0e0b0", mask: "#8a3a38", hat: "#4e3a2c", plume: "#c8403a", pauldron: "#a4aab4", purse: "#8a6038", scroll: "#ecdcb4", seal: "#b83232", offhand: true, blade: "hanger" } },
  assassinUnitBA: { kind: "assassin", box: { hw: 21, up: 30, down: 4 }, p: { h: 22, skin: "#d8b08c", cloth: "#1e1a24", cloth2: "#3a2a3c", hair: "#342a3e", cape: "#8a2a5a", wcol: "#d0d4dc", trim: "#b8a0c0", eyes: "#ff8ad0", veil: "#4e4058", lace: "#cfc6d4", brim: "#cfc6d4", long: true, vials: "#e05aa8", venom: "#e05aa8", blade: "needle" } },
  assassinUnitBB: { kind: "assassin", box: { hw: 22, up: 30, down: 4 }, p: { h: 22, skin: "#d8b08c", cloth: "#2e3a2a", cloth2: "#5a4630", hair: "#4a5238", cape: "#8a8a3a", wcol: "#b8c4b4", trim: "#b89a50", eyes: "#e8f070", mask: "#44583e", beak: "#d8c49a", censer: true, brass: "#b89a50", spore: "#d8e860", vials: "#c8e050", venom: "#b8e04a" } },
